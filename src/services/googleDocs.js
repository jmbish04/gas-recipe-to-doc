...
function createRecipeDoc(recipe, clientSessionId) {
  ...
  // HERO IMAGE ACTIVATION - Pass the active 'doc' reference to prevent handle invalidation
  ...
  if (recipe.imageUrl) {
    try {
      ...
      // Refactored to accept Document object directly
      processAndInjectRecipeImage(recipe.imageUrl, doc);
    } catch (e) {
